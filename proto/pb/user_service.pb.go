...
const file_user_service_proto_rawDesc = "" +
	...
	"\fcontent_type\x18\x02 \x01(\tR\vcontentType2\x81\x05\n" +
	"\vUserService\x12Y\n" +
	"\n" +
	...
	"\x0eDownloadAvatar\x12\x1e.user.v1.DownloadAvatarRequest\x1a\x1f.user.v1.DownloadAvatarResponse0\x01B6Z4github.com/St1cky1/task-service/internal/api/grpc/pbb\x06proto3"
...
var file_user_service_proto_goTypes = []any{
	...
	(*DownloadAvatarRequest)(nil),  // 10: user.v1.DownloadAvatarRequest
	(*DownloadAvatarResponse)(nil), // 11: user.v1.DownloadAvatarResponse
}
var file_user_service_proto_depIdxs = []int32{
	...
	8,  // 6: user.v1.UserService.UploadAvatar:input_type -> user.v1.UploadAvatarRequest
	10, // 7: user.v1.UserService.DownloadAvatar:input_type -> user.v1.DownloadAvatarRequest
	7,  // 8: user.v1.UserService.CreateUser:output_type -> user.v1.UserResponse
	7,  // 9: user.v1.UserService.GetUser:output_type -> user.v1.UserResponse
	7,  // 10: user.v1.UserService.UpdateUser:output_type -> user.v1.UserResponse
	4,  // 11: user.v1.UserService.DeleteUser:output_type -> user.v1.DeleteUserResponse
	6,  // 12: user.v1.UserService.ListUsers:output_type -> user.v1.ListUsersResponse
	9,  // 13: user.v1.UserService.UploadAvatar:output_type -> user.v1.UploadAvatarResponse
	11, // 14: user.v1.UserService.DownloadAvatar:output_type -> user.v1.DownloadAvatarResponse
