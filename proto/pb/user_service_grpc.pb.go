...
type UserServiceClient interface {
	...
	DownloadAvatar(ctx context.Context, in *DownloadAvatarRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadAvatarResponse], error)
}
...
func (c *userServiceClient) DownloadAvatar(ctx context.Context, in *DownloadAvatarRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadAvatarResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[1], UserService_DownloadAvatar_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[DownloadAvatarRequest, DownloadAvatarResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UserService_DownloadAvatarClient = grpc.ServerStreamingClient[DownloadAvatarResponse]
...
type UserServiceServer interface {
	...
	DownloadAvatar(*DownloadAvatarRequest, grpc.ServerStreamingServer[DownloadAvatarResponse]) error
...
func (UnimplementedUserServiceServer) DownloadAvatar(*DownloadAvatarRequest, grpc.ServerStreamingServer[DownloadAvatarResponse]) error {
...
func _UserService_DownloadAvatar_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(UserServiceServer).DownloadAvatar(m, &grpc.GenericServerStream[DownloadAvatarRequest, DownloadAvatarResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UserService_DownloadAvatarServer = grpc.ServerStreamingServer[DownloadAvatarResponse]
