...
const (
	...
	UserService_DownloadAvatar_FullMethodName = "/user.v1.UserService/DownloadAvatar"
)
...
type UserServiceClient interface {
	...
	DownloadAvatar(ctx context.Context, in *DownloadAvatarRequest, opts ...grpc.CallOption) (UserService_DownloadAvatarClient, error)
}
...
func (c *userServiceClient) UploadAvatar(ctx context.Context, opts ...grpc.CallOption) (UserService_UploadAvatarClient, error) {
	...
	x := &userServiceUploadAvatarClient{ClientStream: stream}
	return x, nil
}
...
func (c *userServiceClient) DownloadAvatar(ctx context.Context, in *DownloadAvatarRequest, opts ...grpc.CallOption) (UserService_DownloadAvatarClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[1], UserService_DownloadAvatar_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceDownloadAvatarClient{ClientStream: stream}
...
type UserService_DownloadAvatarClient interface {
	Recv() (*DownloadAvatarResponse, error)
	grpc.ClientStream
}

type userServiceDownloadAvatarClient struct {
	grpc.ClientStream
}

func (x *userServiceDownloadAvatarClient) Recv() (*DownloadAvatarResponse, error) {
	m := new(DownloadAvatarResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type UserServiceServer interface {
	...
	DownloadAvatar(*DownloadAvatarRequest, UserService_DownloadAvatarServer) error
...
func (UnimplementedUserServiceServer) DownloadAvatar(*DownloadAvatarRequest, UserService_DownloadAvatarServer) error {
	return status.Errorf(codes.Unimplemented, "method DownloadAvatar not implemented")
}
...
func _UserService_UploadAvatar_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserServiceServer).UploadAvatar(&userServiceUploadAvatarServer{ServerStream: stream})
}
...
func _UserService_DownloadAvatar_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(DownloadAvatarRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(UserServiceServer).DownloadAvatar(m, &userServiceDownloadAvatarServer{ServerStream: stream})
}

type UserService_DownloadAvatarServer interface {
	Send(*DownloadAvatarResponse) error
	grpc.ServerStream
}

type userServiceDownloadAvatarServer struct {
	grpc.ServerStream
}

func (x *userServiceDownloadAvatarServer) Send(m *DownloadAvatarResponse) error {
	return x.ServerStream.SendMsg(m)
}
